...
<html>
    <head>
        ...
        <img src="logo.png" alt="some image is here" WIDTH=1200 HEIGHT=60>
        <script>
            temp=0;
            temp1=0;
            function CheckEmail()
    ...
    <body>
         ...
         <h2 size="6";color="blue";text-align="center">YALE UNIVERSITY</h2>
         <h4 text-align="center";color="purple">Welcome To Yale University</h4>
